...
abstract class BaseauditTrail extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CoreBundle\\Model\\auditTrailPeer';
    ...
    public function setTimeIn($v)
    {
        ...
        if ($this->time_in !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = auditTrailPeer::TIME_IN;
            }
    ...
    public function setTimeOut($v)
    {
        ...
        if ($this->time_out !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = auditTrailPeer::TIME_OUT;
            }
        } // if either are not null
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = auditTrailPeer::DATE;
            }
        } // if either are not null
    ...
    public function setLevel($v)
    {
        ...
        if ($this->level !== $v) {
            $this->level = $v;
            $this->modifiedColumns[] = auditTrailPeer::LEVEL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = auditTrailPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = auditTrailQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(auditTrailPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(auditTrailPeer::TIME_IN)) {
            $modifiedColumns[':p' . $index++]  = '`time_in`';
        }
        if ($this->isColumnModified(auditTrailPeer::TIME_OUT)) {
            $modifiedColumns[':p' . $index++]  = '`time_out`';
        }
        if ($this->isColumnModified(auditTrailPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(auditTrailPeer::LEVEL)) {
    ...
    {
        if (isset($alreadyDumpedObjects['auditTrail'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['auditTrail'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(auditTrailPeer::TIME_IN)) $criteria->add(auditTrailPeer::TIME_IN, $this->time_in);
        if ($this->isColumnModified(auditTrailPeer::TIME_OUT)) $criteria->add(auditTrailPeer::TIME_OUT, $this->time_out);
        if ($this->isColumnModified(auditTrailPeer::DATE)) $criteria->add(auditTrailPeer::DATE, $this->date);
        if ($this->isColumnModified(auditTrailPeer::LEVEL)) $criteria->add(auditTrailPeer::LEVEL, $this->level);
    ...
    {
        return (string) $this->exportTo(auditTrailPeer::DEFAULT_STRING_FORMAT);
    }
