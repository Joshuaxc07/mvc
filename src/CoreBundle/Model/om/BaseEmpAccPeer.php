...
abstract class BaseEmpAccPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Key', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'key', ),
        BasePeer::TYPE_COLNAME => array (EmpAccPeer::ID, EmpAccPeer::USERNAME, EmpAccPeer::PASSWORD, EmpAccPeer::KEY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD', 'KEY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'key', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Key' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'key' => 3, ),
        BasePeer::TYPE_COLNAME => array (EmpAccPeer::ID => 0, EmpAccPeer::USERNAME => 1, EmpAccPeer::PASSWORD => 2, EmpAccPeer::KEY => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'KEY' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'key' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
